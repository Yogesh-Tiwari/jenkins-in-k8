...
Important points:
1. Default kubernetes svc for k8s url in jenkins cloud configuration: https://kubernetes.default.svc
2. jenkins url for the cloud configuration will be: `http://jenkins:8080` where `jenkins` is the service name for the master jenkins pod.
